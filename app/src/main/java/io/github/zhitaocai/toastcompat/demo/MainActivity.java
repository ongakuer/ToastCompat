...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    @Override protected void onCreate(Bundle savedInstanceState) {
        ...
        ToastCompat.checkToastEnable(getApplicationContext(), true);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            @Override public void onClick(View view) {
                Snackbar.make(view, "BugReports via czt.saisam@gmail.com", Snackbar.LENGTH_LONG)
        ...
        if (v instanceof Button) {
            switch (v.getId()) {
                ...
                case R.id.btn_show_multi_toast:
                    ...
                    ToastCompat.makeText(this, "show Multi Toast : three", Toast.LENGTH_SHORT)
                            .show();
